...
var Snippet = function Snippet(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, props, {
    className: _JSXStyle.dynamic([["384356740", [width, theme.layout.gapHalf, theme.layout.gap, style.color, style.bgColor, style.border, theme.layout.radius, style.color, style.bgColor, theme.layout.gap, theme.layout.radius]]]) + " " + (props && props.className != null && props.className || "snippet ".concat(className))
  }), isMultiLine ? text.map(function (t, index) {
    return /*#__PURE__*/React.createElement("pre", {
      key: "snippet-".concat(index, "-").concat(t),
      className: _JSXStyle.dynamic([["384356740", [width, theme.layout.gapHalf, theme.layout.gap, style.color, style.bgColor, style.border, theme.layout.radius, style.color, style.bgColor, theme.layout.gap, theme.layout.radius]]])
    }, t);
    ...
    className: _JSXStyle.dynamic([["384356740", [width, theme.layout.gapHalf, theme.layout.gap, style.color, style.bgColor, style.border, theme.layout.radius, style.color, style.bgColor, theme.layout.gap, theme.layout.radius]]]) + " " + "copy"

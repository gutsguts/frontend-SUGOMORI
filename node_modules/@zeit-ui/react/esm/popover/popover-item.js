...
var PopoverItem = function PopoverItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", _extends({}, props, {
    className: _JSXStyle.dynamic([["53324749", [theme.layout.gap, theme.palette.accents_5, theme.palette.foreground, theme.palette.border, theme.palette.foreground]]]) + " " + (props && props.className != null && props.className || "item ".concat(line ? 'line' : '', " ").concat(title ? 'title' : '', " ").concat(className))

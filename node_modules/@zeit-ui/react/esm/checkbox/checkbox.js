...
import { getCheckboxSize } from './checkbox-group';
...
var Checkbox = function Checkbox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", _extends({}, props, {
    className: _JSXStyle.dynamic([["3057471586", [fontSize, isDisabled ? 'not-allowed' : 'pointer', isDisabled ? 0.75 : 1, isDisabled ? 'not-allowed' : 'pointer']]]) + " " + (props && props.className != null && props.className || "".concat(className))
    ...
    className: _JSXStyle.dynamic([["3057471586", [fontSize, isDisabled ? 'not-allowed' : 'pointer', isDisabled ? 0.75 : 1, isDisabled ? 'not-allowed' : 'pointer']]])
  }), /*#__PURE__*/React.createElement("span", {
    className: _JSXStyle.dynamic([["3057471586", [fontSize, isDisabled ? 'not-allowed' : 'pointer', isDisabled ? 0.75 : 1, isDisabled ? 'not-allowed' : 'pointer']]]) + " " + "text"
